      ...
      if (req.body.entry[0].changes[0].value.messages[0].text) {
        ...
        await interact({
          ...
          request: {
            ...
            payload: {
              label: req.body.entry[0].changes[0].value.messages[0].interactive?.button_reply.title,
            },
          },
          phoneNumberId,
          userName,
        ...
        await interact({
          ...
          request: {
            type: 'intent',
            payload: {
              query: req.body.entry[0].changes[0].value.messages[0].interactive?.button_reply.title,
              intent: {
